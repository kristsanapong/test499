...
public class MySQLConnect {
    ...
    private String URL = "http://10.80.117.212:8081/", GET_URL = "android/signup.php", SENT_URL="android/sent_post.php";
    ...
    private String GET_HISTORY_DETAIL = "android/getHistory.php";
    // 192.168.1.6
    // "http://10.0.2.2"
    public MySQLConnect(){
        main = null;
...
//                        comment += "*" + collectData.getString("bloodgroup");
    ...
    {
        final String[] name = account.split(" ");
        class SendPost extends AsyncTask<String, Void, String> {
            @Override
            protected String doInBackground(String... strings) {
                try {
    ...
    public void AddHistory(final String Data)
    {
...
//                }
    ...
    {
        final String url = URL + GET_HISTORY_DETAIL;
        class SendPost extends AsyncTask<String, Void, List<String>> {
            @Override
            protected List<String> doInBackground(String... strings) {
                try {
                    ...
                    nameValuePairs.add(new BasicNameValuePair("username",username));
                    DefaultHttpClient httpClient = new DefaultHttpClient();
                    HttpPost httpPost = new HttpPost(url); //detail
                    httpPost.setEntity(new UrlEncodedFormEntity(nameValuePairs,"UTF8"));
                    HttpResponse httpResponse = httpClient.execute(httpPost);
                    HttpEntity httpEntity = httpResponse.getEntity();
                    is = httpEntity.getContent();
